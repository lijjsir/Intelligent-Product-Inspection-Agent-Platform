...
class InspectionStandardLibrary(Base, TimestampMixin):
    ...
    inspection_spec_id: Mapped[str | None] = mapped_column(UUIDBinary, nullable=True, index=True)
    spec_code: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
