...
class AgentDefinition(Base, TimestampMixin):
    ...
    subgraph_key: Mapped[str] = mapped_column(String(64), nullable=False, default="legacy_quality")
...
class RagQueryLog(Base, TimestampMixin):
    ...
    source_graph: Mapped[str] = mapped_column(String(64), nullable=False, default="legacy_quality")
    metadata_json: Mapped[dict | None] = mapped_column(JSON, nullable=True)
