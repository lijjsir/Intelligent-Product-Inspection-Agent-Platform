...
> 状态校正（2026-09-01）：本文最初记录的是 2026-05-21 的实现差距。分片上传、知识图谱 MVP、对齐、增强和 VLM-JSON 导出目前已经有代码、API 和专项测试；剩余工作以真实依赖环境验收、算法质量提升和发布收口为准。下方“未完成功能清单”保留为历史目标差距，不能直接视为当前代码状态。
