  ...
  <div class="feedback-tab">
    <div class="feedback-layout">
      ...
      <section class="feedback-section">
        <h3 class="section-title">人工判定</h3>
          ...
          <div class="review-record">
            <div class="review-head">
              ...
              <span class="review-meta">
                由 {{ result.reviewed_by }} 判定于 {{ result.reviewed_at ? new Date(result.reviewed_at).toLocaleString() : '-' }}
              </span>
            </div>
        ...
        <div v-else-if="canReview" class="review-form">
          <el-form label-position="top" size="small">
            <el-form-item label="产品判定" class="!mb-3">
            ...
            <el-form-item label="判定依据" class="!mb-3">
        ...
        <div v-else class="review-none">
          <span class="text-zinc-400 text-sm">暂无人工判定记录</span>
        </div>
      </section>
