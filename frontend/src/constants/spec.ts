...
export const DEFECT_TYPE_LABELS: Record<string, string> = {
  ...
  // MVTec 细分类规则
  "bottle.bottom.foreign_body": "瓶底异物",
  "grid.structure.breakage": "网格断裂",
  "grid.structure.deformation": "网格形变",
  "grid.hole.blocked": "孔洞堵塞",
  "grid.surface.contamination": "表面污染",
  "hazelnut.shell.crack": "榛子外壳裂纹",
  "hazelnut.surface.mold": "榛子霉斑",
  "hazelnut.surface.insect_damage": "榛子虫蛀",
  "hazelnut.surface.foreign_body": "榛子表面异物",
  "leather.surface.scratch": "皮革划痕",
  "leather.surface.stain": "皮革污渍",
  "leather.surface.wrinkle": "皮革褶皱",
  "leather.surface.hole": "皮革破洞",
  "metal_nut.thread.damage": "金属螺母螺纹损伤",
  "metal_nut.edge.chip": "金属螺母边缘缺口",
  "metal_nut.surface.rust": "金属螺母锈蚀",
  "metal_nut.body.crack": "金属螺母本体裂纹",
  "pill.body.crack": "药片裂纹",
  "pill.body.chip": "药片缺角",
  "pill.color.abnormal": "药片颜色异常",
  "pill.surface.foreign_body": "药片表面异物",
  "screw.thread.damage": "螺丝螺纹损伤",
  "screw.body.bent": "螺丝杆身弯曲",
  "screw.surface.rust": "螺丝锈蚀",
  "screw.head.chip": "螺丝头部缺口",
  "tile.surface.crack": "瓷砖裂纹",
  "tile.edge.chip": "瓷砖边角缺损",
  "tile.surface.scratch": "瓷砖釉面划痕",
  "tile.color.deviation": "瓷砖色差",
  "toothbrush.bristle.missing": "牙刷刷毛缺失",
  "toothbrush.head.deformation": "牙刷刷头变形",
  "toothbrush.surface.contamination": "牙刷污染",
  "toothbrush.handle.crack": "牙刷手柄裂纹",
  "transistor.pin.bent": "晶体管引脚弯曲",
  "transistor.pin.missing": "晶体管引脚缺失",
  "transistor.package.crack": "晶体管封装裂纹",
  "transistor.marking.missing": "晶体管标识缺失",
  "wood.surface.crack": "木材表面裂纹",
  "wood.knot.oversize": "木材节疤超限",
  "wood.surface.insect_hole": "木材虫孔",
  "wood.surface.mold": "木材霉斑",
  "zipper.teeth.missing": "拉链齿缺失",
  "zipper.teeth.misaligned": "拉链错齿",
  "zipper.slider.damage": "拉头损坏",
  "zipper.tape.fraying": "拉链布带破损",
};
