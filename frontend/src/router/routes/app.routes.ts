...
export const appRoutes = [
  ...
  { path: "stability", name: "app-stability-overview", component: () => import("@/views/StabilityOverviewView.vue"), meta: { title: "稳定性监控", roles: NON_END_USER_ROLES } },
  { path: "stability/:id", name: "app-stability-detail", component: () => import("@/views/StabilityDetailView.vue"), meta: { roles: NON_END_USER_ROLES } },
  { path: "alerts", name: "app-alerts", redirect: "/app/stability?tab=alerts", meta: { roles: NON_END_USER_ROLES } },
