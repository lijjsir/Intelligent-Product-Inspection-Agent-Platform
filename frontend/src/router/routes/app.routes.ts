import { ROLE_USER, ROLE_EXPERT, ROLE_PLATFORM_OPERATOR } from "@/constants/roles";
...
export const appRoutes = [
  ...
  { path: "tasks", name: "app-tasks", component: () => import("@/views/TaskListView.vue"), meta: { title: "任务管理", roles: APP_ROLES } },
  { path: "tasks/:id", name: "app-task-detail", component: () => import("@/views/TaskDetailView.vue"), meta: { roles: APP_ROLES } },
  { path: "results", name: "app-results", component: () => import("@/views/ResultListView.vue"), meta: { title: "检测结果", roles: APP_ROLES } },
  { path: "results/:id", name: "app-result-detail", component: () => import("@/views/ResultDetailView.vue"), meta: { title: "证据溯源", roles: APP_ROLES } },
  { path: "feedbacks", name: "app-feedbacks", component: () => import("@/views/quality/FeedbackListView.vue"), meta: { title: "异常反馈", roles: APP_ROLES } },
  ...
  { path: "export", name: "app-export", component: () => import("@/views/placeholder/PlaceholderPage.vue"), meta: { title: "报告导出", roles: APP_ROLES } },
