...
export const opsRoutes = [
  ...
  { path: "training/jobs", name: "ops-training-jobs", component: () => import("@/views/ops/FineTuneManageView.vue"), meta: { title: "训练任务", roles: [ROLE_ALGORITHM_ENGINEER] } },
  { path: "training/jobs/:id", name: "ops-training-jobs-detail", component: () => import("@/views/ops/FineTuneDetailView.vue"), meta: { title: "训练任务详情", roles: [ROLE_ALGORITHM_ENGINEER] } },
