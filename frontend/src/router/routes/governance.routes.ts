...
export const governanceRoutes = [
  ...
  { path: "admin/infrastructure", name: "governance-admin-infrastructure", component: () => import("@/views/admin/InfrastructureView.vue"), meta: { title: "存储/基础设施", roles: [ROLE_ADMIN] } },
  ...
  { path: "admin/product-master", name: "governance-admin-product-master", component: () => import("@/views/admin/ProductMasterView.vue"), meta: { title: "产品主数据", roles: [ROLE_ADMIN] } },
  ...
  // Memory governance
  { path: "memory", name: "governance-memory", component: () => import("@/views/admin/MemoryGovernanceView.vue"), meta: { title: "记忆治理", roles: [ROLE_ADMIN] } },
];
