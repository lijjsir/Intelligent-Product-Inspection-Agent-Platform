...
const GOVERNANCE_ROLES = [ROLE_ADMIN, ROLE_PLATFORM_OPERATOR, ROLE_ALGORITHM_ENGINEER];
...
export const governanceRoutes = [
  ...
  { path: "admin/gpu", name: "governance-admin-gpu", component: () => import("@/views/admin/GpuMonitorView.vue"), meta: { title: "GPU 调度", roles: [ROLE_ADMIN] } },
  { path: "admin/inspection-specs", name: "governance-admin-inspection-specs", component: () => import("@/views/admin/InspectionSpecView.vue"), meta: { title: "检测标准", roles: [ROLE_ADMIN, ROLE_ALGORITHM_ENGINEER] } },
